...
import { Menu, X, Search, Facebook, Twitter, Instagram, Globe } from 'lucide-react';
            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/" className="text-foreground hover:text-primary-600 font-medium px-3">Home</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/about" className="text-foreground hover:text-primary-600 font-medium px-3">About Us</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/work" className="text-foreground hover:text-primary-600 font-medium px-3">Our Work</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/join" className="text-foreground hover:text-primary-600 font-medium px-3">Join Us</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/impact" className="text-foreground hover:text-primary-600 font-medium px-3">Impact</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
            </NavigationMenuList>
          </NavigationMenu>

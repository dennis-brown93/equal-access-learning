      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-serif font-bold">About KindHearts NGO</h2>
            <p className="text-lg text-gray-700">
              KindHearts is a humanitarian organization dedicated to improving the lives of vulnerable 
              communities worldwide. Founded in 2010, we have been working tirelessly to provide 
              education, healthcare, and sustainable development solutions to those in need.
            </p>
            <p className="text-lg text-gray-700">
              Our team of dedicated volunteers and staff members work on the ground in over 30 countries, 
              developing community-led initiatives that create lasting impact and positive change.
            </p>

    ...
    <section className="section bg-primary-100">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Our Vision & Mission</h2>
...
const VisionMissionCard = ({ title, content, icon, iconBg }: VisionMissionCardProps) => {
  return (
    <motion.div
